...
export const projects: Project[] = [
  {
    ...
    stacks: [
      { stackURL: logo.mongodb.src, alt: logo.mongodb.alt },
      { stackURL: logo.express.src, alt: logo.express.alt },
      { stackURL: logo.react.src, alt: logo.react.alt },
      { stackURL: logo.nodejs.src, alt: logo.react.alt },
      { stackURL: logo.css.src, alt: logo.css.alt },
      { stackURL: logo.tailwindcss.src, alt: logo.tailwindcss.alt },
    ],
  },
  {
    id: "2",
    ...
    stacks: [
      ...
      { stackURL: logo.express.src, alt: logo.express.alt },
      { stackURL: logo.react.src, alt: logo.react.alt },
      { stackURL: logo.nodejs.src, alt: logo.nodejs.alt },
      { stackURL: logo.tailwindcss.src, alt: logo.tailwindcss.alt },
    ],
  },
  {
    ...
    stacks: [
      ...
      { stackURL: logo.react.src, alt: logo.react.alt },
      { stackURL: logo.nodejs.src, alt: logo.nodejs.alt },
      { stackURL: logo.chakraUI.src, alt: logo.chakraUI.alt },
    ],
  },
  {
    id: "4",
    ...
    stacks: [
      { stackURL: logo.html.src, alt: logo.html.alt },
      { stackURL: logo.css.src, alt: logo.css.alt },
      { stackURL: logo.javascript.src, alt: logo.javascript.alt },
      { stackURL: logo.sass.src, alt: logo.sass.alt },
    ],
  },
  {
    id: "5",
